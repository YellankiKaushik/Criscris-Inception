...
import { DebriefView } from "@/components/criscris/DebriefView";
import { ScenarioBriefing } from "@/components/criscris/ScenarioBriefing";
import { SimulationShell } from "@/components/criscris/SimulationShell";
...
function Index() {
    ...
    const { state, score, start, restart } = simulation;
    ...
    return <ScenarioBriefing onStart={start} starting={false} />;
}
